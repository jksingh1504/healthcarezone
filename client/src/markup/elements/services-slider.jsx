              ...
              <Slider {...settings} className="service-slide slick-arrow-none">
                <div className="slider-item">
                  <div className="feature-container feature-bx2 feature1">
                    ...
                    <div className="icon-content">
                      <h3 className="ttr-title">Healthcare</h3>
                      <p>
                        Phasellus venenatis porta rhoncus. Integer et viverra
                        felis.
                      </p>
                      <Link
                        to="/service-detail/65477a5b28dd0e06b98d628c"
                ...
                <div className="slider-item">
                  <div className="feature-container feature-bx2 feature2">
                    ...
                    <div className="icon-content">
                      ...
                      <Link
                        to="/service-detail/653d0eb08ab7061accda8f75"
                        className="btn btn-primary light"
                      >
                        Book Now
                      </Link>
                ...
                <div className="slider-item">
                  <div className="feature-container feature-bx2 feature2">
                    ...
                    <div className="icon-content">
                      <h3 className="ttr-title">Blood back</h3>
                      <p>
                        Phasellus venenatis porta rhoncus. Integer et viverra
                        felis.
                      </p>
                      <Link
                        to="/service-detail/653d0ebf8ab7061accda8f77"
                        className="btn btn-primary light"
                      >
                        Book Now
                      </Link>
                ...
                {/* <div className="slider-item">
									<div className="feature-container feature-bx2 feature3">
										...
										<div className="icon-content">
											...
											<Link to="/service-detail" className="btn btn-primary light">Book Now</Link>
										</div>
									</div>
								</div>
								<div className="slider-item">
